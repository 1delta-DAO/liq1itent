...
export interface FillerOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FillerOracle extends BaseContract {
  connect(runner?: ContractRunner | null): FillerOracle;
  waitForDeployment(): Promise<this>;

  interface: FillerOracleInterface;
