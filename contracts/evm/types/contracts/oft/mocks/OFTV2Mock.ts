...
export interface OFTV2MockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface OFTV2Mock extends BaseContract {
  connect(runner?: ContractRunner | null): OFTV2Mock;
  waitForDeployment(): Promise<this>;

  interface: OFTV2MockInterface;
