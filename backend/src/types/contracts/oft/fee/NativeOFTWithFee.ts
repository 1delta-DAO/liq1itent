...
export interface NativeOFTWithFeeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BP_DENOMINATOR"
...
export namespace DepositEvent {
  export type InputTuple = [_dst: AddressLike, _amount: BigNumberish];
  export type OutputTuple = [_dst: string, _amount: bigint];
  export interface OutputObject {
    _dst: string;
    _amount: bigint;
  }
...
export namespace WithdrawalEvent {
  export type InputTuple = [_src: AddressLike, _amount: BigNumberish];
  export type OutputTuple = [_src: string, _amount: bigint];
  export interface OutputObject {
    _src: string;
    _amount: bigint;
  }
...
export interface NativeOFTWithFee extends BaseContract {
  connect(runner?: ContractRunner | null): NativeOFTWithFee;
  waitForDeployment(): Promise<this>;

  interface: NativeOFTWithFeeInterface;
  ...
  outboundAmount: TypedContractMethod<[], [bigint], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "outboundAmount"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
