...
export interface NativeOFTV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface NativeOFTV2 extends BaseContract {
  connect(runner?: ContractRunner | null): NativeOFTV2;
  waitForDeployment(): Promise<this>;

  interface: NativeOFTV2Interface;
